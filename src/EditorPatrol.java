...
public class EditorPatrol extends EditorObject {	
	private BufferedImage sprites;
	
	public EditorPatrol(BufferedImage sprites) {
		this.sprites = sprites;
	}
	
	@Override
	public GameObject createObject(GameController gameController, float posX, float posY) {
		obj = new Patrol(gameController, posX, posY, sprites);
		return obj;
	}
	...
	public GameObject importObject(GameController gameController, String s) {
		...
		return new Patrol(gameController, posX, posY, sprites);
	}
}
