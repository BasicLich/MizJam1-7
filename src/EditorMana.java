...
public class EditorMana extends EditorObject {
	private BufferedImage sprites;
	private UI ui;
	
	public EditorMana(BufferedImage sprites, UI ui) {
	...
	public GameObject createObject(GameController gameController, float posX, float posY) {
		obj = new Mana(gameController, posX, posY, sprites, ui);
		return obj;
	}
	...
	public GameObject importObject(GameController gameController, String s) {
		...
		return new Mana(gameController, posX, posY, sprites, ui);
	}
}
