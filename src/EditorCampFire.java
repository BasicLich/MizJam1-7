...
public class EditorCampFire extends EditorObject {
	private BufferedImage sprites;
	
	public EditorCampFire(BufferedImage sprites) {
		this.sprites = sprites;
	}
	
	@Override
	public GameObject createObject(GameController gameController, float posX, float posY) {
		obj = new CampFire(gameController, posX, posY, sprites);
		return obj;
	}
	...
	public GameObject importObject(GameController gameController, String s) {
		...
		return new CampFire(gameController, posX, posY, sprites);
	}
}
