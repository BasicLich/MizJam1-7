...
public class EditorHeart extends EditorObject {
	private BufferedImage sprites;
	private UI ui;
	
	public EditorHeart(BufferedImage sprites, UI ui) {
	...
	public GameObject createObject(GameController gameController, float posX, float posY) {
		obj = new Heart(gameController, posX, posY, sprites, ui);
		return obj;
	}
	...
	public GameObject importObject(GameController gameController, String s) {
		...
		return new Heart(gameController, posX, posY, sprites, ui);
	}
}
