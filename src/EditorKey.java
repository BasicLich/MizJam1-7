...
public class EditorKey extends EditorObject {
	private BufferedImage sprites;
	
	public EditorKey(BufferedImage sprites) {
		this.sprites = sprites;
	}
	
	@Override
	public GameObject createObject(GameController gameController, float posX, float posY) {
		obj = new Key(gameController, posX, posY, sprites);
		return obj;
	}
	...
	public GameObject importObject(GameController gameController, String s) {
		...
		return new Key(gameController, posX, posY, sprites);
	}
}
