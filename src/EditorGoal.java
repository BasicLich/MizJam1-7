...
public class EditorGoal extends EditorObject {
	private BufferedImage sprites;
	private UI ui;
	
	public EditorGoal(BufferedImage sprites, UI ui) {
	...
	public GameObject createObject(GameController gameController, float posX, float posY) {
		obj = new Goal(gameController, posX, posY, sprites, ui);
		return obj;
	}
	...
	public GameObject importObject(GameController gameController, String s) {
		...
		return new Goal(gameController, posX, posY, sprites, ui);
	}
}
